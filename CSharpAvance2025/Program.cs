internal class CSharpAvance2025
{
    private static void Main(string[] args)
    {
        Console.WriteLine("Entrez un calcul simple: "); // permet de saisir une expression simple
        var input = Console.ReadLine(); // lire la saisie de l'utilisateur
        ...
        var parts = input.Split(op); // permet de diviser l'expression en deux parties
        if (parts.Length == 2)
        {
